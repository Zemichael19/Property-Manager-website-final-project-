...
const apartments = [
  ...
  new Apartment({property: properties[0].id, n_rooms: 2, n_bathrooms: 1,listed: true, furnished:true, floor: 2,sqFoot:2300,pets: false,laundry: true,parking: false,ac: true,u_num: 209}),
  new Apartment({property: properties[1].id, n_rooms: 6, n_bathrooms: 5,listed: true, furnished:false, floor: 8,sqFoot:5500,pets: true,laundry: false,parking: true,s_date: 'October 2019' ,e_date: 'April 2020',ac: false,u_num: 806}),
  ...
  new Apartment({property: properties[1].id, n_rooms: 1, n_bathrooms: 1,listed: true, furnished:true, floor: 1,sqFoot:800,pets: false,laundry: true,parking: true,s_date: 'June 2018' ,e_date: 'June 2021',ac: true,u_num: 110}),
  new Apartment({property: properties[1].id, n_rooms: 4, n_bathrooms: 5,listed: true, furnished:false, floor: 4,sqFoot:4300,pets: false,laundry: false,parking: true,s_date: 'January 2017' ,e_date: 'January 2020',ac: true,u_num: 409}),
  ...
  new Apartment({property: properties[2].id, n_rooms: 2, n_bathrooms: 2,listed: true, furnished:true, floor: 1,sqFoot:1200,pets: false,laundry: true,parking: false,s_date: 'April 2019' ,e_date: 'April 2020',ac: false,u_num: 101}),
