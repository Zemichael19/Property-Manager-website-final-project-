...
const apartments = [
  ...
  new Apartment({property: properties[0].id, n_rooms: 2, n_bathrooms: 1,listed: true, furnished:true, floor: 2,sqFoot:1100,pets: true,laundry: true,parking: true,s_date: 'January 2017' ,e_date: 'January 2020',ac: true,u_num: 209}),
  new Apartment({property: properties[0].id, n_rooms: 1, n_bathrooms: 1,listed: false, furnished:false, floor: 3,sqFoot:800,pets: true,laundry: true,parking: true,s_date: 'October 2019' ,e_date: 'April 2020',ac: true,u_num: 303}),
