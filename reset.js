...
const apartments = [
  ...
  new Apartment({property: properties[0].id, n_rooms: 2, n_bathrooms: 8,listed: true, furnished:true, floor: 2,sqFoot:2300,pets: false,laundry: true,parking: false,s_date: 'January 2017' ,e_date: 'January 2020',ac: true,u_num: 209}),
